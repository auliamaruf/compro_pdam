            ...
            <div id="mobile-menu" class="lg:hidden hidden">
                ...
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
                    ...
                    <div class="border-t border-gray-200 mt-2 pt-2">
                        ...
                        <a href="{{ route('check-bill') }}" class="mobile-nav-link text-green-600">
                            <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                            Cek Tagihan
                        </a>
                        <a href="{{ route('complaint') }}" class="mobile-nav-link text-red-600">
                            <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            Pengaduan Online
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="{{ route('complaint') }}" class="text-blue-200 hover:text-white transition-colors duration-200 flex items-center group">
                        ...
                        <li><a href="{{ route('check-bill') }}" class="text-blue-200 hover:text-white transition-colors duration-200 flex items-center group">
