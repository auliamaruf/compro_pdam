        ...
        <div class="hero-content container-custom">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <p class="hero-description">
                    @if($query)
                        Ditemukan {{ $totalResults }} hasil untuk pencarian Anda
                    @else
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Pencarian</h3>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Pencarian Populer</h3>
                    <div class="space-y-2">
            ...
            <div class="lg:col-span-3">
                ...
                <!-- Filter Tabs -->
                <div class="flex flex-wrap justify-start mb-6 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="{{ route('search', array_merge(request()->query(), ['page' => $currentPage - 1])) }}"
                               class="relative inline-flex items-center px-3 py-2 text-sm font-medium text-gray-500 bg-white dark:bg-gray-800 border border-gray-300 rounded-md hover:bg-gray-50">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @if($start > 1)
                                ...
                                @if($start > 2)
                                    <span class="relative inline-flex items-center px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300">...</span>
                                @endif
                            @endif
                ...
                <div class="text-center py-16">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Tidak Ada Hasil</h2>
                ...
                <div class="text-center py-16">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Masukkan Kata Kunci</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
