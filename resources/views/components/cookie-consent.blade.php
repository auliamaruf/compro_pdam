<div id="cookie-consent-banner" class="fixed bottom-0 left-0 right-0 z-50 transform translate-y-full transition-transform duration-500 ease-in-out hidden">
    <div class="bg-white border-t border-gray-200 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] px-4 py-6 md:py-5 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            
            <div class="flex-1 pr-4">
                <div class="flex items-center gap-2 mb-2">
                    <h3 class="text-base font-bold text-gray-900">Mari Bicarakan Cookies</h3>
                </div>
            ...
            <div class="flex flex-shrink-0 flex-row gap-3 w-full md:w-auto mt-2 md:mt-0">
                <button id="btn-decline-cookies" class="flex-1 md:flex-none px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-4 focus:outline-none focus:ring-gray-100 transition-colors">
                    Tolak
                </button>
