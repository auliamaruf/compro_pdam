    ...
    <div class="container-custom py-8">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-8">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Cari Keluhan</h2>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400">{{ $complaint->subject }}</p>
                        </div>
                        <div class="mt-4 md:mt-0">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                                ...
                                @elseif($complaint->status === 'closed') bg-gray-100 dark:bg-gray-800 text-gray-800
                ...
                <!-- Status Timeline -->
                <div class="mb-8">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Status Penanganan</h3>
                    <div class="flow-root">
                        <ul class="-mb-8">
                            <!-- Received -->
                            <li>
                                <div class="relative pb-8">
                                    ...
                                    <div class="relative flex space-x-3">
                                        ...
                                        <div class="min-w-0 flex-1 pt-1.5">
                                            <div>
                                                <p class="text-sm font-medium text-gray-900 dark:text-white">Keluhan Diterima</p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Detail Keluhan</h3>
                        <div class="space-y-3">
                            <div>
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Nama Pelanggan:</span>
                                <p class="text-gray-900 dark:text-white">{{ $complaint->customer_name }}</p>
                            </div>
                            <div>
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Email:</span>
                                <p class="text-gray-900 dark:text-white">{{ $complaint->email }}</p>
                            </div>
                            <div>
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Telepon:</span>
                                <p class="text-gray-900 dark:text-white">{{ $complaint->phone }}</p>
                            </div>
                            <div>
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Jenis Keluhan:</span>
                                <p class="text-gray-900 dark:text-white">{{ $complaint->complaint_type_display }}</p>
                            </div>
                            <div>
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Prioritas:</span>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 dark:text-white whitespace-pre-wrap">{{ $complaint->address }}</p>

                        @if($complaint->attachments && count($complaint->attachments) > 0)
                        <h4 class="text-md font-semibold text-gray-900 dark:text-white mt-6 mb-3">Lampiran</h4>
                        <div class="space-y-2">
                ...
                <!-- Description -->
                <div class="mb-8">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Deskripsi Keluhan</h3>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <h4 class="font-medium text-gray-900 dark:text-white">Customer Service</h4>
                            <p class="text-blue-600 font-semibold">(0281) 895-123</p>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Senin - Jumat: 07:30 - 15:30</p>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <h4 class="font-medium text-gray-900 dark:text-white">Emergency Hotline</h4>
                            <p class="text-red-600 font-semibold">(0281) 895-911</p>
                            <p class="text-sm text-gray-600 dark:text-gray-400">24 Jam untuk keluhan darurat</p>
                        </div>
                    </div>
                </div>
            </div>
