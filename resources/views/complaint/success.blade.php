    ...
    <div class="container-custom py-16">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 text-center">
                ...
                <!-- Success Message -->
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Keluhan Berhasil Dikirim!</h1>
                <p class="text-lg text-gray-600 dark:text-gray-400 mb-8">
                    Terima kasih telah mengirimkan keluhan Anda. Kami akan segera menindaklanjuti.
                </p>

                <!-- Ticket Info -->
                <div class="bg-blue-50 dark:bg-gray-800 border border-blue-200 rounded-lg p-6 mb-8">
                ...
                <!-- Complaint Details -->
                <div class="text-left bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            <span class="font-medium text-gray-600 dark:text-gray-400">Jenis Keluhan:</span>
                            <p class="text-gray-900 dark:text-white">{{ $complaint->complaint_type_display }}</p>
                        </div>
                        <div>
                            <span class="font-medium text-gray-600 dark:text-gray-400">Prioritas:</span>
                        ...
                        <div class="md:col-span-2">
                            <span class="font-medium text-gray-600 dark:text-gray-400">Subjek:</span>
                            <p class="text-gray-900 dark:text-white">{{ $complaint->subject }}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-8 text-center">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            <p class="font-medium text-gray-600 dark:text-gray-400">Customer Service</p>
                            <p class="text-blue-600">(0281) 895-123</p>
                            <p class="text-gray-500">Senin - Jumat: 07:30 - 15:30</p>
                        </div>
                        <div>
                            <p class="font-medium text-gray-600 dark:text-gray-400">Emergency Hotline</p>
