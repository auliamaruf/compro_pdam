...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('company_settings', function (Blueprint $table) {
            ...
            $table->json('history_timeline')->nullable(); // Array timeline sejarah
            $table->json('achievements')->nullable(); // Array pencapaian
            
            // Organization Structure
            $table->json('organization_structure')->nullable(); // Array struktur organisasi
            $table->text('organization_structure_description')->nullable();
